  ...
  return (
    <section id="main_section" className="mt-5">
      ...
      >
        ...
        <div style={{ height: "100vh" }} data-aos="fade-right">
          <img
            src={fruit_back}
            style={{ width: "100%", height: "100%", objectFit: "cover" }}
            alt="Background"
        ...
        <div style={{ height: "100vh" }} data-aos="fade-right">
          ...
          <div className="content" style={{ backdropFilter: "blur(10px)" }}>
            ...
            <h3>
              Discover the rich flavors and nutritional benefits of our premium
              leaf dehydrated powders and flakes. Perfect for enhancing your
              dishes, our products offer a convenient way to incorporate the
              goodness of leafy greens into your meals.
            </h3>
            <button>Know More</button>
          </div>
        </div>
        ...
        <div style={{ height: "100vh" }} data-aos="fade-right">
          ...
          <div className="content" style={{ backdropFilter: "blur(40px)" }}>
            ...
            <h3 style={{ color: "white" }}>
              Experience the enchanting aroma and health benefits of our premium
              rose dehydrated powders and flakes. Ideal for culinary uses and
              natural remedies, our products add a touch of elegance and
              wellness to your dishes and beverages.
            </h3>
            <button>Know More</button>
          </div>
        </div>
